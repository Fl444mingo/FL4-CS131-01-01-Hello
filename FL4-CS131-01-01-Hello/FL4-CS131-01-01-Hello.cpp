/* The #include directive tells the compiler where to find input(keyboard) and output(screen) information.
Words with special meaning, like "#include" and "using" and "int" are called keywords or reserved words.
They usually are given a color in an IDE or Integrated Development Environment like VisualStudio. */
#include <iostream>
